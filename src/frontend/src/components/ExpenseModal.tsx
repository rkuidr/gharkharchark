...
export function ExpenseModal({
  ...
  const addExpense = useLocalAddExpense(userId ?? null);
  const updateExpense = useLocalUpdateExpense(userId ?? null);
        ...
        <div className="px-5 py-4 space-y-5">
          ...
          <div>
            <label
              ...
              className="block text-xs font-semibold text-gk-text-secondary uppercase tracking-wide mb-2"
            >
              Amount
            </label>
          ...
          {/* Category */}
          <div>
            <span className="block text-xs font-semibold text-gk-text-secondary uppercase tracking-wide mb-2">
              Category
            </span>
