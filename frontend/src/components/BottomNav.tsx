...
import { Home, Calendar, BarChart2, FileText, Settings } from 'lucide-react';
            ...
            >
              <div className={`p-1.5 rounded-xl transition-all duration-200 ${
                ...
                <Icon
                  ...
                  className={isActive ? 'text-gk-accent' : 'text-gk-text-secondary'}
                />
              </div>
              <span className={`text-[10px] font-semibold ${isActive ? 'text-gk-accent' : 'text-gk-text-secondary'}`}>
                {label}
              </span>
            </button>
          );
